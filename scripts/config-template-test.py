...
GRAPHDB_REPO_URI = 'https://graphdb.test.gsq.digital/repositories/{}'.format(GRAPHDB_REPO_ID) 
GRAPHDB_LOAD_DATA_URI = 'https://graphdb.test.gsq.digital/rest/data/import/upload/{}/url'.format(GRAPHDB_REPO_ID) 
